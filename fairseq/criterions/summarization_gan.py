...
class SummarizationCtcGanCriterionConfig(FairseqDataclass):
    gan_loss_coefficient: int = field(
        default=1,
        metadata={"help": "The coefficient of GAN loss in calculation of the total loss"},
    )
    reconstruction_loss_coefficient: int = field(
        default=1,
        metadata={"help": "The coefficient of reconstruction loss in calculation of the total loss"},
    )
    cross_entropy_loss_coefficient: int = field(
        default=1,
        metadata={"help": "The coefficient of cross entropy loss in calculation of the total loss"},
    )
    # TODO: finish the remaining part of this criterion


@register_criterion("summarization_gan", dataclass=SummarizationCtcGanCriterionConfig)
